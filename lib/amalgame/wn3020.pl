...
myalign(Type, SourceVoc, TargetVoc) :-
	...
	align(AmbiguousLabel, TargetVoc, alignment_element, isub_match, target_candidate, NearMatch, OptionsDef, _A2c),
	best_numeric:partition(NearMatch, NearSPartition, [disamb(source)]),
	debug_partition(jaccard_gloss_source, NearSPartition),
